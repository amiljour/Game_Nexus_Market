...
<body>
	...
	<div class="md:hidden flex justify-center items-center sticky top-0 z-50 bg-base-100">
	    ...
	    <!-- Page Currently On -->
	    <h2 id="mobile-menu-trigger" class="cursor-pointer text-xl font-semibold">Edit ${category.name}</h2>
	</div>
  ...
  <div class="flex flex-col w-3/5 lg:w-600px mx-auto my-5">
    <h2 class="hidden md:hidden lg:block text-center mb-5 text-3xl font-semibold dark:text-white">Edit ${category.name}</h2>
