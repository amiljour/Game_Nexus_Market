...
<body>
    ...
    <path stroke="currentColor" stroke-linecap="round"
						...
						<li><a href="/itemsNotAvaiable"
							class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500  block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
	...
	<div>
		...
		<h1 class="text-center mb-5 text-4xl font-semibold dark:text-white my-3">All Items Out of Stock</h1>
