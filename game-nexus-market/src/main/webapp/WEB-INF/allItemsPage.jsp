...
<body>
		    ...
		    <div class="w-full px-4 py-3 mx-auto">
		        <div class="flex items-center justify-around">
		            <ul class="flex flex-row flex-wrap justify-around font-medium mt-0 space-x-8 rtl:space-x-reverse text-white text-md items-center w-full mx-24">
						...
						<li>
							<button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" class="flex items-center justify-between w-full py-2  hover:text-accent">
								Categories
						...
						<!-- All Items -->	
						<li><a href="/allItems" class="block py-2 text-info rounded hover:text-accent">All Items</a></li>
	...
	<div class="md:hidden flex justify-between items-center sticky top-0 z-50 bg-base-100">
	    ...
	    <!-- Page Currently On -->
	    <h2 id="mobile-menu-trigger" class="cursor-pointer text-xl font-semibold">All Items</h2>
	...
	<div class="md:hidden hidden sticky top-10 z-50" id="mobile-menu">
	    <ul class="flex flex-col text-center text-xl text-white p-4 mt-4 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-100 dark:border-gray-600">
			...
			<li>
				<button id="dropdownNavbarLink2" data-dropdown-toggle="dropdownNavbar2" class="flex items-center justify-center w-full block py-2 px-3  rounded hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Categories
				...
				<div id="dropdownNavbar2" class="hidden z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
					<ul class="py-2 text-xl text-info dark:text-gray-200" aria-labelledby="dropdownLargeButton">
						<c:forEach var="category" items="${categories}">
 							<li>
			...
			<!-- All Items -->
	        <li><a href="/allItems" class="block py-2 px-3 text-info rounded hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">All Items</a></li>
	...
	<!-- Items -->
	<h1 class="hidden md:hidden lg:block text-center text-5xl font-semibold dark:text-white my-5">All Items</h1>
