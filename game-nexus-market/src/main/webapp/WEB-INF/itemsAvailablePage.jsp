...
<body>
		    ...
		    <div class="w-full px-4 py-3 mx-auto">
		        <div class="flex items-center justify-around">
		            <ul class="flex flex-row flex-wrap justify-around font-medium mt-0 space-x-8 rtl:space-x-reverse text-md items-center w-full mx-24">
						...
						<!-- Items Available -->
						<li><a href="/itemsAvailable" class="block py-2 text-info rounded hover:text-accent">Items Available</a></li>
	...
	<div class="md:hidden flex justify-between items-center sticky top-0 z-50 bg-base-100">
	    ...
	    <!-- Page Currently On -->
	    <h2 id="mobile-menu-trigger" class="cursor-pointer text-xl font-semibold">Items Available</h2>
	...
	<div class="md:hidden hidden sticky top-0 z-50" id="mobile-menu">
	    <ul class="flex flex-col text-center text-xl text-white p-4 mt-4 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-100 dark:border-gray-600">
	        ...
	        <!-- Items Available -->
	        <li><a href="/itemsAvailable" class="block py-2 px-3 text-info rounded hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Items Available</a></li>
	...
	<div>
		...
		<h1 class="hidden md:hidden lg:block text-center mb-5 text-4xl font-semibold dark:text-white my-3">All Items In Stock</h1>
