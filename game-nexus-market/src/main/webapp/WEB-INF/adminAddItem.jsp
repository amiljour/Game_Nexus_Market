...
<body>
		    ...
		    <div class="w-full px-4 py-3 mx-auto">
		        <div class="flex items-center justify-around">
		            <ul class="flex flex-row flex-wrap justify-around font-medium mt-0 space-x-8 rtl:space-x-reverse text-md items-center w-full mx-24">
						...
						<!-- Admin Home -->
						<li><a href="/admin" class="block py-2  rounded hover:text-accent" aria-current="page">Admin Home</a></li>	
						
						<!-- Add Category -->	
						<li><a href="/admin/add/category" class="block py-2  rounded hover:text-accent">Add Category</a></li>
						
						<!-- Add Item -->
						<li><a href="/admin/add/item" class="block py-2 text-info rounded hover:text-accent">Add Item</a></li>
	...
	<div class="md:hidden flex justify-center items-center sticky top-0 z-50 bg-base-100">
	    ...
	    <!-- Page Currently On -->
	    <h2 id="mobile-menu-trigger" class="cursor-pointer text-xl font-semibold">Add Item</h2>
	</div>
	...
	<div class="md:hidden hidden sticky top-10 z-50" id="mobile-menu">
	    <ul class="flex flex-col text-center text-xl text-white p-4 mt-4 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-100 dark:border-gray-600">
			...
			<!-- Add Item -->
			<li><a href="/admin/add/item" class="block py-2 px-3 text-info rounded hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Add Item</a></li>
	...
	<div class="flex flex-col w-3/5 lg:w-600px mx-auto my-5">
		<h2 class="hidden md:hidden lg:block text-center mb-5 text-3xl font-semibold dark:text-white">Add an Item</h2>
