...
<body>
	...
	<div class="md:hidden flex justify-center items-center sticky top-0 z-50 bg-base-100">
	    ...
	    <!-- Page Currently On -->
	    <h2 id="mobile-menu-trigger" class="cursor-pointer text-xl font-semibold">Add Category</h2>
	</div>
	...
	<div class="md:hidden hidden sticky top-10 z-50" id="mobile-menu">
	    <ul class="flex flex-col text-center text-xl text-white p-4 mt-4 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-100 dark:border-gray-600">
			...
			<!-- Add Category -->	
			<li><a href="/admin/add/category" class="block py-2 px-3 text-info rounded hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Add Category</a></li>
  ...
  <div class="flex flex-col w-3/5 lg:w-600px mx-auto my-5">
    <h2 class="hidden md:hidden lg:block text-center mb-5 text-3xl font-semibold dark:text-white">Add a Category</h2>
    <form:form action="/admin/add/category" method="POST" modelAttribute="newCategory">
